...
//                    Logger.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        int padding = Utils.dip2px(context, 15);
        tv.setPadding(padding, padding, padding, padding);
        if (0 == itemHeight) {
            itemHeight = Utils.getViewMeasuredHeight(tv);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                ...
                itemView.setTextColor(Color.parseColor("#646464"));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#51db64"));
            paint.setStrokeWidth(Utils.dip2px(context, 1f));
        }
...
//        viewWidth = w;
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
        	if(selectedIndex > -1 && !TextUtils.isEmpty(items.get(selectedIndex))){
