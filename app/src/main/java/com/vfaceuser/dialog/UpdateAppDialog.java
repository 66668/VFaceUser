...
public class UpdateAppDialog extends Dialog implements View.OnClickListener{
	...
	public UpdateAppDialog(Context context,String content,boolean ifForce,UpdateAppDialogCallBack callBack) {
	...
	private void initForce(String title,String content){
		...
		View dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_force_update_app, null);
